...
// Check if email is auto-generated (wallet login)
...
export default function SettingsPage() {
  ...
  // Check if user has a real email or auto-generated one
  const hasRealEmail = user?.email && !isAutoGeneratedEmail(user.email);

  useEffect(() => {
    if (user) {
      // Don't show auto-generated email in the input
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      {/* Email Section - Different display based on whether user has real email */}
      {hasRealEmail ? (
        <>
          {/* Email Verification - Only show for real emails */}
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-heading-3 text-white flex items-center gap-2">
        ...
        /* Add Email - For wallet users without real email */
