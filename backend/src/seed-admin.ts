...
// Wallet address to promote as admin. Override at runtime with the
// ADMIN_WALLET env var, e.g. `ADMIN_WALLET=0x... npm run seed:admin`.
const ADMIN_WALLET_ADDRESS =
  process.env.ADMIN_WALLET || '0xc45dA42549db105012bf2c2E3B4f94430045F5Ac';
