...
exports.WalletsModule = WalletsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([wallet_entity_1.Wallet]), users_module_1.UsersModule],
        controllers: [wallets_controller_1.WalletsController],
        providers: [wallets_service_1.WalletsService, encryption_service_1.EncryptionService],
